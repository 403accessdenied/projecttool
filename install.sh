...
echo -e "\n-----------------------FINISHED INSTALLING PWNXSS------------------------"

#INSTALL CORS SCANNER
echo -e "\n-----------------------INSTALLING CORS SCANNER------------------------"
cd ./tools
git clone https://github.com/chenjj/CORScanner
cd -
pip3 install --user -r ./tools/CORScanner/requirements.txt
echo -e "\n-----------------------FINISHED INSTALLING CORS SCANNER------------------------"
